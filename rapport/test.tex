...
\titre{Démonstration de la Classe \texttt{rapport.cls}}
\UE{UE Informatique Avancée}
\sujet{Projet de typographie avec \LaTeX}
\enseignant{M. Jean Dupont}
\eleves{Jeanne Martin \\ Paul Durand}
...
\begin{document}
	...
	% Activation des en-têtes et pieds de page personnalisés pour le reste du document
	\fairemarges
